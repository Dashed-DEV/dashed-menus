...
class NavigationResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Navigaties';
    protected static ?string $label = 'Navigatie';
    protected static ?string $pluralLabel = 'Navigaties';
            ...
            ->schema([
                Card::make([
                    ...
                    ViewField::make('items')
                        ->default([])
                        ->view('qcommerce-menus::navigation-builder'),
                ])
                    ->columnSpan([
                        12,
                        'lg' => 8,
